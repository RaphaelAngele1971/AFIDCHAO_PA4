{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "def2f85c-a71e-4986-bddc-a89dbec9e077",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "100ecb85-ae26-4944-b473-d59d341556b8",
   "metadata": {},
   "source": [
    "Create the following data frame based on the format provided:"
   ]
  },
  {
   "cell_type": "markdown",
   "id": "5ffa2487-a6fd-4e55-999e-f96f87a08bcf",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "91bd63b7-1d57-4869-95dd-4830701fea9e",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "501552c4-bd50-4cdd-b8ca-df28a5acec0f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "ae3d8cdf-f5da-4b22-ba54-f4f75d1cad3a",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "boards['Average']=((boards['Math'])+(boards['Electronics'])+(boards['GEAS'])+(boards['Communication']))/4\n",
    "boards"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "7eef1953-4ebb-4028-ae65-4b6087d0f006",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "boards.loc[(boards['Hometown']=='Mindanao')&(boards['Gender']=='Female')&(boards['Average']>=55), ['Name','Track','Electronics','Average']]"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "96e5c74d-c401-477b-9d5c-b435f03b1735",
   "metadata": {},
   "outputs": [],
   "source": []
  }
